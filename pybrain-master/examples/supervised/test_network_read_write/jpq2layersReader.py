...
def myplot(trns, ctrns=None, tsts=None, ctsts=None, iter=0):
    ...
    path_ = '/Users/zhangjiawei/Code/Machine-Learning/pybrain-master/examples/supervised/test_network_read_write/zjw.jpg'
...
path = '/Users/zhangjiawei/Code/Machine-Learning/pybrain-master/examples/supervised/test_network_read_write/trndata'
#trndata = SupervisedDataSet.loadFromFile(os.path.join(os.getcwd(),'trndata'))
trndata = SupervisedDataSet.loadFromFile(path)
